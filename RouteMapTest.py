...
class RouteMapTest(unittest.TestCase):
    def setUp(self):
        ...
        self.routes = RouteMap(input_file_path)
    
    def test_find_route_length(self):
        known_route_lengths = [('ABC', 9),  # Test 1
                               ('AD', 5),  # Test 2
                               ('ADC', 13),  # Test 3
                               ('AEBCD', 22),  # Test 4
    ...
    def test_find_number_routes(self):
        known_number_routes = [(('C', 'C', 3, RouteMap.DistanceType.MAX_STOPS), 2),  # Test 6
    ...
    def test_find_shortest_route(self):
        known_shortest_routes = [(('A', 'C'), 9),  # Test 8
                                 (('B', 'B'), 9),]  # Test 9
